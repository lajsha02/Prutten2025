...
Vi bygger en resväska som består av saker i ett träd: en sak kan antingen vara en pryl eller
en mindre väska som i sin tur innehåller fler saker.
Med Iterator gör vi det lätt att gå igenom allt innehåll steg för steg.
Tanken är att klientkoden bara ska kunna “loopa” över sakerna som om det vore en vanlig lista.
Vi bygger tre klasser:
...
\begin{itemize}
\item\texttt{Bredden först (BFS):} först roten, sedan alla barn, sedan barnbarn osv.
\item\texttt{Preorder (DFS):} besök en nod, gå sedan ner i dess barn innan du går vidare.
\end{itemize}
...
\nwenddocs{}\nwbegincode{35}\moddef{Composite iterability}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
  @Override
...
\nwenddocs{}\nwbegincode{39}\moddef{BFS fields}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{41}\moddef{BFS ctor}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{43}\moddef{BFS hasNext}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
  @Override
...
\nwenddocs{}\nwbegincode{45}\moddef{BFS next}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
  @Override
...
\nwenddocs{}\nwbegincode{47}\moddef{BFS remove}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
  @Override
  public void remove() \{
...
\nwenddocs{}\nwbegincode{49}\moddef{PreorderIterator.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
import java.util.ArrayDeque;
import java.util.Deque;
import java.util.Iterator;
import java.util.List;
...
\nwenddocs{}\nwbegincode{51}\moddef{PRE fields}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{53}\moddef{PRE ctor}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\subsubsection{\texttt{hasNext}}
\nwenddocs{}\nwbegincode{55}\moddef{PRE hasNext}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
  @Override
  public boolean hasNext() \{
...
\nwenddocs{}\nwbegincode{57}\moddef{PRE next}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
  @Override
  public Component next() \{
...
\nwenddocs{}\nwbegincode{59}\moddef{PRE remove}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
  @Override
  public void remove() \{
    throw new UnsupportedOperationException();
  \}
...
\nwenddocs{}\nwbegincode{61}\moddef{Client.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
public class Client \{
...
\nwenddocs{}\nwbegincode{63}\moddef{Client build-structure}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{65}\moddef{Client print-before}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{67}\moddef{Client removals}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{69}\moddef{Client print-after}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{71}\moddef{Client iterate-bfs}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{73}\moddef{Client iterate-preorder}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
